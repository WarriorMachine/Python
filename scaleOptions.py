class scaleOptions:
    ...
    highlightcolor=None, highlightthickness=None, label=None,orient=VERTICAL, page=main, relief=FLAT, repeatdelay=None, resolution=1 ,showvalue=1, sliderlength=30, state=None, takefocus=None, tickinterval=10, to=100, troughcolor=None,
    variable=None, width=75, sliderwidth=15, x=0, y=0):
        ...
        if bordercolor == None or bordercolor == 0 or highlightthickness == 0:
            bordercolor = bg

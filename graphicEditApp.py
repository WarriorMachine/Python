...
try:
    main.iconbitmap("Planning Requierement (optional)/write list.ico")
except:
...
reduire = Button(backFrameBar, text="━", relief = FLAT, bd = 0, bg = '#111111', fg = 'gray80', cursor="cross", activebackground='#534692')
